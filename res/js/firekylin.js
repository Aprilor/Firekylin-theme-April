(function (win, doc) {
  ...
  Dom.bindEvent = function () {
    ...
    this.$btn_side.addEventListener(eventSecond, function () {
      ...
      if (_this.$button.className.indexOf(button_class_name) > -1) {
        _this.$button.className = _this.$button.className.replace(button_class_name, '');
        _this.$header.className = _this.$header.className.replace(button_class_name, '');
      } else {
        _this.$button.className += (button_class_name);
        _this.$header.className += (button_class_name);
      }
